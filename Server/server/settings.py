"""
Django settings for annapurnaserver project.
...
SECRET_KEY = '%s10bn!gc@gv32bq-7@i+mgq2-4)n51ost36x=nib=!%*67ki9'
...
ROOT_URLCONF = 'annapurnaserver.urls'
...
WSGI_APPLICATION = 'annapurnaserver.wsgi.application'
